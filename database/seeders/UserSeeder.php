...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::factory(20)->create()->each(function ($user) use ($adminRole, $teacherRole, $studentRole) {
            // Assigner un rôle aléatoire parmi admin, teacher et student
            $roles = [$adminRole, $teacherRole, $studentRole];
            $user->assignRole($roles[array_rand($roles)]->name);
        });
